...
from text import contextual_content, paper_content
...
def save_audio_to_wav(
    audio_data, output_filename, sample_width=2, channels=1, framerate=44100
):
...
def speechtoText():
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            {
                "role": "system",
                "content": "You are a paper summarier that answer questions about the paper I passed in. \
